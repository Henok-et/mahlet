...
export default function PublicationsSection({ data }: PublicationsSectionProps) {
  ...
  return (
    <section className="section bg-light" id="publications">
      <div className="container">
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
          {data.map((pub) => (
            <div key={pub._id} style={{ padding: "1.5rem", background: "var(--color-bg)", borderRadius: "0.5rem", borderLeft: "4px solid var(--color-primary)", boxShadow: "0 2px 8px rgba(0,0,0,0.05)" }}>
